...
Re-publishes events received from edge nodes.
"""
...
class MQTTPublisher:
    """MQTT publisher for SmartPark server v2."""
    ...
    def __init__(
        ...
        self.client = mqtt.Client(client_id="smartpark-server-v2")
    ...
    def publish_node_health(self, health: Dict[str, Any]):
